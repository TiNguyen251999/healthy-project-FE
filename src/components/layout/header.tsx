...
function Header() {
  ...
  return (
    <>
      <div className="header-container header md">
      ...
      <Offcanvas show={show} onHide={handleClose} placement="end">
        ...
        <Offcanvas.Body className="p-0">
          <ul className="list-group">
            <li className="list-group-item">自分の記録</li>
            <li className="list-group-item">体重グラフ</li>
            <li className="list-group-item">選択中のコース</li>
            <li className="list-group-item">コラム一覧</li>
            <li className="list-group-item">設定</li>
          </ul>
        </Offcanvas.Body>
      </Offcanvas>
    </>
